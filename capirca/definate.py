...
from capirca.def_libs import definition_filter
from capirca.def_libs import file_filter
from capirca.def_libs import filter_factory
from capirca.def_libs import generator_factory
from capirca.def_libs import global_filter
from capirca.def_libs import yaml_validator


_parser = OptionParser()
_parser.add_option('-c', '--config', dest='configuration',
                   help='configuration file',
                   default='./definate.yaml')
